/********************************************************************************
** Form generated from reading UI file 'editproductzone.ui'
**
...
#ifndef UI_EDITPRODUCTZONE_H
#define UI_EDITPRODUCTZONE_H
...
public:
    ...
    void setupUi(QDialog *EditProductZone)
    {
        if (EditProductZone->objectName().isEmpty())
            EditProductZone->setObjectName(QStringLiteral("EditProductZone"));
        EditProductZone->resize(868, 755);
        label = new QLabel(EditProductZone);
        ...
        groupBox = new QGroupBox(EditProductZone);
...
"background-color: rgb(136, 138, 133);"));
        label_2 = new QLabel(EditProductZone);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(0, 0, 881, 751));
        label_2->setStyleSheet(QStringLiteral("border-image: url(:/resources/background/picklit.jpg);"));
        label_2->raise();
        label->raise();
        groupBox->raise();

        retranslateUi(EditProductZone);

        QMetaObject::connectSlotsByName(EditProductZone);
    } // setupUi

    void retranslateUi(QDialog *EditProductZone)
    {
        EditProductZone->setWindowTitle(QApplication::translate("EditProductZone", "Dialog", Q_NULLPTR));
        label->setText(QString());
        groupBox->setTitle(QApplication::translate("EditProductZone", "Add New Product Zone", Q_NULLPTR));
        lbl_username->setText(QApplication::translate("EditProductZone", "Zone Description", Q_NULLPTR));
        lbl_phone->setText(QApplication::translate("EditProductZone", "Zone Name", Q_NULLPTR));
        btnApply->setText(QApplication::translate("EditProductZone", "Ok", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("EditProductZone", "Cancel", Q_NULLPTR));
        label_11->setText(QApplication::translate("EditProductZone", "*Please take uttermost care before editing or deleting any information from the table*", Q_NULLPTR));
...
namespace Ui {
    class EditProductZone: public Ui_EditProductZone {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_EDITPRODUCTZONE_H
