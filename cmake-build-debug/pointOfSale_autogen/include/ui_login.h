...
public:
    ...
    void setupUi(QDialog *Login)
    {
        ...
        label->setStyleSheet(QStringLiteral("border-image: url(:/resources/wood.jpg);"));
        ...
        label_2->setGeometry(QRect(10, 257, 371, 71));
        QFont font;
...
"border-radius: 5px;"));
        ...
        btnCancel->setGeometry(QRect(170, 130, 91, 31));
        QIcon icon1;
        ...
        lblTime->setGeometry(QRect(278, 330, 101, 31));
        QFont font1;
        font1.setPointSize(13);
        lblTime->setFont(font1);
        lblTime->setStyleSheet(QLatin1String("\n"
"color: rgb(255, 255, 255);\n"
"padding-left:8px;\n"
"border-radius: 8px;"));
        lblDate = new QLabel(Login);
        lblDate->setObjectName(QStringLiteral("lblDate"));
        lblDate->setGeometry(QRect(150, 330, 111, 31));
        lblDate->setFont(font1);
        lblDate->setStyleSheet(QLatin1String("\n"
"color: rgb(255, 255, 255);\n"
"padding-left:8px;\n"
"border-radius: 8px;"));
        line_2 = new QFrame(Login);
        line_2->setObjectName(QStringLiteral("line_2"));
        line_2->setGeometry(QRect(270, 330, 3, 30));
