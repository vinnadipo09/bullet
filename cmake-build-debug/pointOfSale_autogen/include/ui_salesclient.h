...
"padding:4px;"));
        ...
        gridLayout->addWidget(label_33, 7, 1, 1, 1);
...
"padding:4px;"));
        ...
        gridLayout->addWidget(label_42, 9, 1, 1, 1);
...
"background-color: rgb(186, 189, 182);"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/resources/new_icons_2/icons8-plus-96.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnViewStockStatus->setIcon(icon4);
        btnViewStockStatus->setIconSize(QSize(24, 24));

        gridLayout->addWidget(btnViewStockStatus, 7, 0, 1, 1);
...
"padding:4px;"));
        ...
        gridLayout->addWidget(label_34, 8, 1, 1, 1);
...
"padding: 1.5px;\n"
"background-color: rgb(186, 189, 182);"));
        btnViewStockStatus_2->setIcon(icon4);
        btnViewStockStatus_2->setIconSize(QSize(24, 24));

        gridLayout->addWidget(btnViewStockStatus_2, 16, 0, 1, 1);
...
"padding:4px;"));
        ...
        gridLayout->addWidget(label_45, 16, 1, 1, 1);
...
"padding:4px;"));
        ...
        gridLayout->addWidget(label_38, 17, 1, 1, 1);
...
"background-color: rgb(186, 189, 182);"));
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/resources/new_icons_2/icons8-minus-100.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_12->setIcon(icon6);
        pushButton_12->setIconSize(QSize(24, 24));

        gridLayout->addWidget(pushButton_12, 8, 0, 1, 1);
...
"background-color: rgb(186, 189, 182);"));
        ...
        gridLayout->addWidget(pushButton_13, 17, 0, 1, 1);
...
"background-color: rgb(186, 189, 182);"));
        ...
        gridLayout->addWidget(btnIncreaseQty_2, 14, 0, 1, 1);
...
"padding: 1.5px;\n"
"background-color: rgb(186, 189, 182);"));
        btnReduceQtyByOne->setIcon(icon6);
...
"padding: 1.5px;\n"
"background-color: rgb(186, 189, 182);"));
        btnReduceQtyByOne_2->setIcon(icon6);
        btnReduceQtyByOne_2->setIconSize(QSize(24, 24));

        gridLayout->addWidget(btnReduceQtyByOne_2, 9, 0, 1, 1);
...
"padding:4px;"));
        ...
        gridLayout->addWidget(label_46, 15, 1, 1, 1);
...
"padding:4px;"));
        ...
        gridLayout->addWidget(label_44, 10, 1, 1, 1);
