/********************************************************************************
** Form generated from reading UI file 'supervisorwindow.ui'
**
...
public:
    ...
    QPushButton *pb_logout_supervisor;
    ...
    void setupUi(QMainWindow *SupervisorWindow)
    {
        if (SupervisorWindow->objectName().isEmpty())
            SupervisorWindow->setObjectName(QStringLiteral("SupervisorWindow"));
        SupervisorWindow->resize(2919, 944);
        centralwidget = new QWidget(SupervisorWindow);
        ...
        frame_2->setStyleSheet(QStringLiteral("background-color: rgb(143, 89, 2);"));
        frame_2->setFrameShape(QFrame::StyledPanel);
        frame_2->setFrameShadow(QFrame::Raised);
        label_8 = new QLabel(frame_2);
        label_8->setObjectName(QStringLiteral("label_8"));
        label_8->setGeometry(QRect(540, 2, 131, 16));
        ...
        pb_logout_supervisor = new QPushButton(frame);
        pb_logout_supervisor->setObjectName(QStringLiteral("pb_logout_supervisor"));

        verticalLayout_2->addWidget(pb_logout_supervisor);
        ...
        label_2->setGeometry(QRect(540, 220, 421, 301));
        QFont font;
        ...
        frame_4->setStyleSheet(QStringLiteral("background-color: rgb(143, 89, 2);"));
        ...
        frame_5->setStyleSheet(QStringLiteral("background-color: rgb(143, 89, 2);"));
        ...
        frame_6->setStyleSheet(QStringLiteral("background-color: rgb(143, 89, 2);"));
        ...
        SupervisorWindow->setCentralWidget(centralwidget);
        menubar = new QMenuBar(SupervisorWindow);
        menubar->setObjectName(QStringLiteral("menubar"));
        menubar->setGeometry(QRect(0, 0, 2919, 20));
        SupervisorWindow->setMenuBar(menubar);
        statusbar = new QStatusBar(SupervisorWindow);
        statusbar->setObjectName(QStringLiteral("statusbar"));
        SupervisorWindow->setStatusBar(statusbar);

        retranslateUi(SupervisorWindow);

        stackedWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(SupervisorWindow);
    } // setupUi

    void retranslateUi(QMainWindow *SupervisorWindow)
    {
        SupervisorWindow->setWindowTitle(QApplication::translate("SupervisorWindow", "MainWindow", Q_NULLPTR));
        pushButton_13->setText(QApplication::translate("SupervisorWindow", "PushButton", Q_NULLPTR));
        label_8->setText(QApplication::translate("SupervisorWindow", "SUPERVISOR CENTRAL", Q_NULLPTR));
        label->setText(QString());
        pushButton_dashboard->setText(QApplication::translate("SupervisorWindow", "Dashboard", Q_NULLPTR));
        pushButton_users->setText(QApplication::translate("SupervisorWindow", "Users", Q_NULLPTR));
        pushButton_8->setText(QApplication::translate("SupervisorWindow", "Dashboard", Q_NULLPTR));
        pushButton_4->setText(QApplication::translate("SupervisorWindow", "Two", Q_NULLPTR));
        pushButton_3->setText(QApplication::translate("SupervisorWindow", "Three", Q_NULLPTR));
        pushButton_12->setText(QApplication::translate("SupervisorWindow", "Four", Q_NULLPTR));
        pushButton_7->setText(QApplication::translate("SupervisorWindow", "Dashboard", Q_NULLPTR));
        pushButton_9->setText(QApplication::translate("SupervisorWindow", "Dashboard", Q_NULLPTR));
        pushButton_6->setText(QApplication::translate("SupervisorWindow", "Dashboard", Q_NULLPTR));
        pushButton_10->setText(QApplication::translate("SupervisorWindow", "Dashboard", Q_NULLPTR));
        pushButton_11->setText(QApplication::translate("SupervisorWindow", "Five", Q_NULLPTR));
        btn_viewProfile->setText(QApplication::translate("SupervisorWindow", "View Profile", Q_NULLPTR));
        pb_logout_supervisor->setText(QApplication::translate("SupervisorWindow", "Logout", Q_NULLPTR));
        label_2->setText(QApplication::translate("SupervisorWindow", "DASHBOARD", Q_NULLPTR));
        pushButton_addNewUser->setText(QApplication::translate("SupervisorWindow", "Add User", Q_NULLPTR));
        btn_loadUsers->setText(QApplication::translate("SupervisorWindow", "Load Users", Q_NULLPTR));
        label_3->setText(QApplication::translate("SupervisorWindow", "USERS", Q_NULLPTR));
        label_5->setText(QApplication::translate("SupervisorWindow", "CASHIERS", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = tableWidgetCashiers->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("SupervisorWindow", "User ID", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidgetCashiers->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("SupervisorWindow", "First Name", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidgetCashiers->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("SupervisorWindow", "Other Names", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidgetCashiers->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("SupervisorWindow", "Email", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidgetCashiers->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("SupervisorWindow", "Phone Number", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidgetCashiers->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("SupervisorWindow", "Username", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem6 = tableWidgetCashiers->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("SupervisorWindow", "User Role", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem7 = tableWidgetCashiers->horizontalHeaderItem(7);
        ___qtablewidgetitem7->setText(QApplication::translate("SupervisorWindow", "Avatar", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem8 = tableWidgetCashiers->horizontalHeaderItem(8);
        ___qtablewidgetitem8->setText(QApplication::translate("SupervisorWindow", "View User", Q_NULLPTR));
        label_6->setText(QApplication::translate("SupervisorWindow", "SUPERVISORS", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidgetSupervisors->horizontalHeaderItem(0);
        ___qtablewidgetitem9->setText(QApplication::translate("SupervisorWindow", "User ID", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem10 = tableWidgetSupervisors->horizontalHeaderItem(1);
        ___qtablewidgetitem10->setText(QApplication::translate("SupervisorWindow", "First Name", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem11 = tableWidgetSupervisors->horizontalHeaderItem(2);
        ___qtablewidgetitem11->setText(QApplication::translate("SupervisorWindow", "New Column", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem12 = tableWidgetSupervisors->horizontalHeaderItem(3);
        ___qtablewidgetitem12->setText(QApplication::translate("SupervisorWindow", "Other Names", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem13 = tableWidgetSupervisors->horizontalHeaderItem(4);
        ___qtablewidgetitem13->setText(QApplication::translate("SupervisorWindow", "Email", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem14 = tableWidgetSupervisors->horizontalHeaderItem(5);
        ___qtablewidgetitem14->setText(QApplication::translate("SupervisorWindow", "Phone Number", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem15 = tableWidgetSupervisors->horizontalHeaderItem(6);
        ___qtablewidgetitem15->setText(QApplication::translate("SupervisorWindow", "Username", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem16 = tableWidgetSupervisors->horizontalHeaderItem(7);
        ___qtablewidgetitem16->setText(QApplication::translate("SupervisorWindow", "User Role", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem17 = tableWidgetSupervisors->horizontalHeaderItem(8);
        ___qtablewidgetitem17->setText(QApplication::translate("SupervisorWindow", "Avatar", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem18 = tableWidgetSupervisors->horizontalHeaderItem(9);
        ___qtablewidgetitem18->setText(QApplication::translate("SupervisorWindow", "View Record", Q_NULLPTR));
        label_7->setText(QApplication::translate("SupervisorWindow", "ADMINISTRATORS", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem19 = tableWidgetAdministrators->horizontalHeaderItem(0);
        ___qtablewidgetitem19->setText(QApplication::translate("SupervisorWindow", "User ID", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem20 = tableWidgetAdministrators->horizontalHeaderItem(1);
        ___qtablewidgetitem20->setText(QApplication::translate("SupervisorWindow", "First Name", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem21 = tableWidgetAdministrators->horizontalHeaderItem(2);
        ___qtablewidgetitem21->setText(QApplication::translate("SupervisorWindow", "New Column", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem22 = tableWidgetAdministrators->horizontalHeaderItem(3);
        ___qtablewidgetitem22->setText(QApplication::translate("SupervisorWindow", "Other Names", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem23 = tableWidgetAdministrators->horizontalHeaderItem(4);
        ___qtablewidgetitem23->setText(QApplication::translate("SupervisorWindow", "Email", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem24 = tableWidgetAdministrators->horizontalHeaderItem(5);
        ___qtablewidgetitem24->setText(QApplication::translate("SupervisorWindow", "Phone Number", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem25 = tableWidgetAdministrators->horizontalHeaderItem(6);
        ___qtablewidgetitem25->setText(QApplication::translate("SupervisorWindow", "Username", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem26 = tableWidgetAdministrators->horizontalHeaderItem(7);
        ___qtablewidgetitem26->setText(QApplication::translate("SupervisorWindow", "User Role", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem27 = tableWidgetAdministrators->horizontalHeaderItem(8);
        ___qtablewidgetitem27->setText(QApplication::translate("SupervisorWindow", "Avatar", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem28 = tableWidgetAdministrators->horizontalHeaderItem(9);
        ___qtablewidgetitem28->setText(QApplication::translate("SupervisorWindow", "View Record", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class SupervisorWindow: public Ui_SupervisorWindow {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SUPERVISORWINDOW_H
