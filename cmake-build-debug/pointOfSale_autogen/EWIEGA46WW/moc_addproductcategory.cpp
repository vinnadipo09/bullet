...
QT_MOC_LITERAL(3, 41, 33), // "productCategoryOperationsComp..."
QT_MOC_LITERAL(4, 75, 19), // "on_btnApply_clicked"
QT_MOC_LITERAL(5, 95, 20) // "on_btnCancel_clicked"

    },
    "AddProductCategory\0categoryAddedSuccess\0"
    "\0productCategoryOperationsComplete\0"
...
void AddProductCategory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->productCategoryOperationsComplete(); break;
        ...
        {
            typedef void (AddProductCategory::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddProductCategory::productCategoryOperationsComplete)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void AddProductCategory::productCategoryOperationsComplete()
{
